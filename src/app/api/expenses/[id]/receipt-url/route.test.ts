...
describe("GET /api/expenses/[id]/receipt-url (org-scoped via the guard)", () => {
  ...
  it("returns a signed URL for an expense in the caller's Active Organization", async () => {
          ...
          expenses: [
            {
              ...
              receipt_path: "org-1/exp-1-receipt.jpg",
            },
          ],
        },
      }).client as never,
    ...
    expect(body.url).toContain("org-1/exp-1-receipt.jpg");
  });
          ...
          expenses: [
            {
              ...
              receipt_path: "org-2/exp-1-receipt.jpg",
            },
          ],
        },
      }).client as never,
