...
// only the list GET is tightened to `access_settings` by #107.
describe("GET /api/settings/contract-templates — gated on access_settings (#107)", () => {
  ...
  it("lists templates when the caller holds access_settings", async () => {
    authed({
      user: { id: "u" },
      tables: memberTables({
        userId: "u",
