...
// All four methods of the job-status catalog are gated on access_settings.
describe("GET /api/settings/statuses — gated on access_settings (#107)", () => {
  ...
  it("lists statuses when the caller holds access_settings", async () => {
    authed(holds());
...
describe("POST /api/settings/statuses — gated on access_settings (#107)", () => {
  it("401 unauthenticated", async () => {
    authed({ user: null });
...
describe("PUT /api/settings/statuses — gated on access_settings (#107)", () => {
  it("401 unauthenticated", async () => {
    authed({ user: null });
...
describe("DELETE /api/settings/statuses — gated on access_settings (#107)", () => {
  it("401 unauthenticated", async () => {
    authed({ user: null });
