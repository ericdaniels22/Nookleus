...
describe("GET /api/settings/appearance — gated on access_settings (#107)", () => {
  ...
  it("returns brand colors when the caller holds access_settings", async () => {
    authed(holds());
...
describe("PUT /api/settings/appearance — gated on access_settings (#107)", () => {
  it("returns 401 when unauthenticated", async () => {
    authed({ user: null });
  ...
  it("saves brand colors when the caller holds access_settings", async () => {
    authed(holds());
