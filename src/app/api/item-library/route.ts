...
// GET /api/item-library — reading the library needs either `view_estimates`
// or `view_invoices` (admins auto-pass). Expressed as a multi-key
// `permission` rule, which the wrapper treats as any-of.
...
// POST /api/item-library — creating a library item needs the
