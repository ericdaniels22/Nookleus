...
export function PdfPresetsSection() {
  ...
  return (
    <div className="space-y-4">
      ...
      <div className="flex items-center justify-between">
        <div>
          <h2 className="text-lg font-semibold text-foreground">PDF Presets</h2>
          <p className="text-sm text-muted-foreground mt-0.5">
            Control how estimates and invoices look when rendered as PDFs.
          </p>
        </div>
