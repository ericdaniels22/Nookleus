...
// #230 — extracted body of the pre-redesign /settings/expense-categories
// page. The only change from the original is renaming the default export
// to a named `ExpenseCategoriesTab`. UI and behavior are unchanged.
        ...
        <div className="bg-card rounded-xl border border-border p-4 space-y-3">
          ...
          <div className="flex gap-2 pt-1">
            <button onClick={handleAdd}
              className="inline-flex items-center gap-1 px-3 py-1.5 rounded-lg text-xs font-medium border border-input bg-transparent text-text-secondary hover:bg-muted hover:text-foreground">
              <Check size={14} /> Add
            </button>
