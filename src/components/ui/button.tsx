...
// §5: primary = solid emerald (one per view); the legacy `gradient` key stays
// as an alias so call sites keep compiling. `outline` and `secondary` are the
// same secondary treatment — transparent bg, --input border, --text-secondary.
const solidPrimary =
  "bg-primary text-primary-foreground hover:bg-primary/90 active:bg-primary/80 [a]:hover:bg-primary/90"
const secondaryOutline =
  "border-input bg-transparent text-text-secondary hover:bg-muted hover:text-foreground aria-expanded:bg-muted aria-expanded:text-foreground"
