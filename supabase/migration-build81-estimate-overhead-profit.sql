-- ============================================
-- Build 81 Migration: #572 — Overhead & Profit on Estimates
--
-- Splits the Estimate's single Markup into two independent uplifts — Overhead
-- and Profit ("10 & 10") — each applied on top of the RAW Subtotal. Together
-- they form the Markup: markup_amount = overhead_amount + profit_amount.
--
...
--
-- Scope: estimates only. Invoices keep their single Markup (counterpart #575).
--
